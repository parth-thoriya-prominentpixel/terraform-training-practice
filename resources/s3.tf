...
# resource "aws_s3_object" "uploaded_to_s3_tf_task" {
#   bucket = module.s3_bucket.s3_bucket_bucket_domain_name
#   key    = "/"      
#   source = "./s3_static_code_files/index.html"    
#   etag   = filemd5("./s3_static_code_files/index.html") # keep tract of file if any changes is detected then re upload it
#   acl    = "private"
